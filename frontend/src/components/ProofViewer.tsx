  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        reportDiagnostic("error", "ProofViewer", "on-chain settlement read failed", e instanceof Error ? e.message : String(e));
      } finally {
        setLoading(false);
      }
    })();
  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <p style={{ color: "#9aa3bf", fontSize: "0.85rem" }}>
          On-chain settlement data temporarily unavailable.
        </p>
      ) : (
